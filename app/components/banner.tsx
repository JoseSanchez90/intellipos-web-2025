...
const Banner = () => {
    return ( 
      <div className="relative h-[500px] 2xl:h-[580px] mx-20 rounded-lg overflow-auto flex justify-center items-center border border-gray-900 ">
        ...
        <div className="absolute flex flex-col items-center justify-center">
          <div className="p-5 bg-opacity-50 rounded-l text-center max-w-3xl">
            <h1 className="text-5xl text-white font-bold">Sistema de Venta <span className="text-5xl text-green-400 font-bold">Aloha NCR</span></h1>
